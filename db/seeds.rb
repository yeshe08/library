...
Bookid.create!([
  {book_id: "6789", is_issue: false, is_blocked: true, book_detail_id: 1},
  {book_id: "6543", is_issue: false, is_blocked: true, book_detail_id: 1},
  {book_id: "12345", is_issue: true, is_blocked: true, book_detail_id: 1}
])
Entry.create!([
  {issue_date: "2018-04-04", return_date: nil, bookid_id: 1, user_id: 3, tempissue: true},
  {issue_date: "2018-04-04", return_date: nil, bookid_id: 1, user_id: 3, tempissue: true},
  {issue_date: "2018-04-04", return_date: nil, bookid_id: 2, user_id: 3, tempissue: true},
  {issue_date: "2018-04-04", return_date: nil, bookid_id: 3, user_id: 3, tempissue: true},
  {issue_date: "2018-03-27", return_date: "2018-04-27", bookid_id: 1, user_id: 3, tempissue: false},
  {issue_date: "2018-03-27", return_date: "2018-04-27", bookid_id: 1, user_id: 3, tempissue: false}
])
